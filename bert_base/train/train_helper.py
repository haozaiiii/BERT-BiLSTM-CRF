...
def get_args_parser():
    ...
    if os.name == 'nt':
        ...
        # change by pyh
        # bert_path = r'D:\workspace\gitdownload\BERT-BiLSTM-CRF-NER\wwm_cased_L-24_H-1024_A-16'
        # bert_path = r'D:\workspace\gitdownload\BERT-BiLSTM-CRF-NER\chinese_L-12_H-768_A-12'
        bert_path = r'D:\workspace\gitdownload\BERT-BiLSTM-CRF-NER\uncased_L-12_H-768_A-12'
        root_path = r'D:\workspace\gitdownload\BERT-BiLSTM-CRF-NER'
    else:
        # bert_path = '/home/macan/ml/data/chinese_L-12_H-768_A-12/'
        # root_path = '/home/macan/ml/workspace/BERT-BiLSTM-CRF-NER'
        # change by pyh
        bert_path = '/home/panyinghao/project/git/BERT-BiLSTM-CRF-NER/uncased_L-12_H-768_A-12/'
        root_path = '/home/panyinghao/project/git/BERT-BiLSTM-CRF-NER/'

    group1 = parser.add_argument_group('File Paths',
                                       'config the path, checkpoint and filename of a pretrained/fine-tuned BERT model')
    group1.add_argument('-data_dir', type=str, default=os.path.join(root_path, 'NERdataTest'),

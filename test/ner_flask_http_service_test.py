...
if os.name == 'nt':
    ...
    if str(config['WIN']['use_gpu']).lower() == 'true':
        ...
        gpu_config.device_count = {"CPU": config['cpu']['cpu_num']}
        gpu_config.intra_op_parallelism_threads = config['cpu']['intra_op_parallelism_threads']
        gpu_config.inter_op_parallelism_threads = config['cpu']['inter_op_parallelism_threads']
else:
...
def test():
    query = r'第一百零五条 药品监督管理部门建立药品上市许可持有人、药品生产企业、药品经营企业、药物非临床安全性评价研究机构、药物临床试验机构和医疗机构药品安全信用档案，记录许可颁发、日常监督检查结果、违法行为查处等情况，依法向社会公布并及时更新；对有不良信用记录的，增加监督检查频次，并可以按照国家规定实施联合惩戒。'
    tokens = r"['第', '一', '百', '零', '五', '条', '药', '品', '监', '督', '管', '理', '部', '门', '建', '立', '药', '品', '上', '市', '许', '可', '持', '有', '人', '、', '药', '品', '生', '产', '企', '业', '、', '药', '品', '经', '营', '企', '业', '、', '药', '物', '非', '临', '床', '安', '全', '性', '评', '价', '研', '究', '机', '构', '、', '药', '物', '临', '床', '试', '验', '机', '构', '和', '医', '疗', '机', '构', '药', '品', '安', '全', '信', '用', '档', '案', '，', '记', '录', '许', '可', '颁', '发', '、', '日', '常', '监', '督', '检', '查', '结', '果', '、', '违', '法', '行', '为', '查', '处', '等', '情', '况', '，', '依', '法', '向', '社', '会', '公', '布', '并', '及', '时', '更', '新', '；', '对', '有', '不', '良', '信', '用', '记', '录', '的', '，', '增', '加', '监', '督', '检', '查', '频', '次', '，', '并', '可', '以', '按', '照', '国', '家', '规', '定', '实', '施', '联', '合', '惩', '戒', '。']"
    tags = r"['O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'B-yinxiangsi', 'I-yinxiangsi', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O']"
    ret_list = find_index_int_token_tag(query,list(tokens),list(tags))
    print(ret_list)
